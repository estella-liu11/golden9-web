    ...
    return (
        <div className="min-h-screen bg-white py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* Social Media Embeds */}
                <div className="mt-16">
                    <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">Follow Our Updates</h2>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        {/* Facebook Image */}
                        <div className="bg-white border border-gray-200 rounded-lg p-4">
                            <h3 className="text-xl font-semibold text-gray-900 mb-4 text-center">Facebook</h3>
                        ...
                        {/* Xiaohongshu Image */}
                        <div className="bg-white border border-gray-200 rounded-lg p-4">
                            <h3 className="text-xl font-semibold text-gray-900 mb-4 text-center">小红书</h3>
                            <div className="w-full" style={{ height: '500px' }}>
                                <img
                                    src={rednote}
                                    alt="小红书二维码"
