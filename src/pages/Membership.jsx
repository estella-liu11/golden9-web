...
export default function Membership() {
    ...
    const handleSubscribe = (tier) => {
        ...
        alert(`Please visit our store to apply for the ${tier} membership plan`);
    };
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-gray-50 rounded-lg p-8 text-center">
                    ...
                    <p className="text-gray-600 mb-6">
                        Please visit our store in person to consult with our staff, learn more about membership details, and complete the registration process. We will provide you with professional guidance and services.
                    </p>
                    <button
                        className="inline-block px-8 py-3 bg-primary text-white rounded-lg font-semibold hover:bg-purple-700 transition-colors"
                        onClick={() => alert('Please contact store staff')}
                    >
                        Contact Us
                    </button>
                </div>
